...
class TestOneVideoPerBlob(CellectsUnitTest):
    ...
    def test_write_videos_with_different_video_shapes(self):
        min_ram_free = 0
        ...
        # bunch_nb, video_nb_per_bunch, sizes, video_bunch, vid_names, rom_memory_required, analysis_status, remaining = self.po.videos.prepare_video_writing(
        #     img_list, min_ram_free)
