...
# THIS FILE IS NECESSARY TO CREATE A WINDOWS EXECUTABLE AND ITS INSTALLER
...
ICON_FILE = ICONS_DIR / "cellects_icon.ico"
...
exe = EXE(pyz,
          ...
          entitlements_file=None , icon=["icons/cellects_icon.ico"])
